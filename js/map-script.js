...
function initialize() {
	...
	var mapOptions = {
		...
		center: new google.maps.LatLng(42.800586, -77.479708),
		panControl: true,
		zoomControl: true,
		mapTypeControl: true,
		//scaleControl: false,
	...
	var marker1 = new MarkerWithLabel({
		position: new google.maps.LatLng(42.800493, -77.479942),
		draggable: false,
		raiseOnDrag: false,
		icon: ' ',
		map: map,
		labelContent: '<div class="de-icon circle small-size" style="background-color:#f0394d;"><i class="de-icon-bell-alt"></i></div>',
		labelAnchor: new google.maps.Point(29, 20),
		labelClass: "labels" // the CSS class for the label
	});

	var marker2 = new MarkerWithLabel({
		position: new google.maps.LatLng(42.801056, -77.480059),
		draggable: false,
		raiseOnDrag: false,
		icon: ' ',
		map: map,
